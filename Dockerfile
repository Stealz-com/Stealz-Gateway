...
WORKDIR /app/Stealz-Gateway
COPY Stealz-Gateway/pom.xml ./
RUN mvn dependency:go-offline -DskipTests

COPY Stealz-Gateway/src ./src
...
EXPOSE 8080
HEALTHCHECK --interval=30s --timeout=3s --start-period=60s --retries=3     CMD nc -z localhost 8080 || exit 1
